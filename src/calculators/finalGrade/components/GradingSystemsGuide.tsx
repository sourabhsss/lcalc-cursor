      ...
      <CardContent>
        <div className="space-y-6">
          ...
          <div className="bg-accent/10 p-4 rounded-md border border-border">
            ...
            <p className="text-sm text-muted-foreground mt-3">
              For a comprehensive approach to managing your GPA, use our <a href="/college-gpa-calculator" className="text-primary hover:underline">College GPA Calculator</a> alongside this Final Grade Calculator.
            </p>
          </div>
        </div>
      </CardContent>
