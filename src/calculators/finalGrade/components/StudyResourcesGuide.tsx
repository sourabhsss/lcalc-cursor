        ...
        <Tabs defaultValue="online">
          ...
          <TabsContent value="tools" className="space-y-4 mt-4">
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-2 text-sm text-muted-foreground">
                <li><a href="/college-gpa-calculator" className="text-primary hover:underline">College GPA Calculator</a>: Track and project your cumulative GPA</li>
                <li><a href="/percentage-to-cgpa-calculator" className="text-primary hover:underline">Percentage to CGPA Calculator</a>: Convert between grading systems</li>
                <li><a href="/ap-lang-score-calculator" className="text-primary hover:underline">AP Lang Score Calculator</a>: Estimate AP exam scores</li>
