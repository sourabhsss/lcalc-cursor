          ...
          <AccordionItem value="item-8">
            ...
            <AccordionContent>
              ...
              <ul className="list-disc list-inside space-y-1 mt-1 text-sm text-muted-foreground">
                <li>Using our <a href="/percentage-to-cgpa-calculator" className="text-primary hover:underline">Percentage to CGPA Calculator</a> for specific conversions</li>
              ...
              <div className="mt-3 space-y-3">
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-1 text-xs text-muted-foreground">
                    ...
                    <li><span className="font-medium">Our College GPA Calculator:</span> Use our <a href="/college-gpa-calculator" className="text-primary hover:underline">College GPA Calculator</a> to monitor overall academic progress</li>
                  </ul>
                </div>
